			...
			<div  id="FeedBack" class="rwd-height margin10B" style="overflow:hidden; border-radius: 10px;">
				<div class="BoxBgWa feedback-left">
					...
					<div class="twocol margin5B">
						...
						<div style="margin-bottom:10px; padding-top: 10px;"><input type="text" id="feedbackStr" name="keyword" value="" onkeypress="" class="form-control" placeholder="more comments…" /></div>
						<div class="right">
							<input type="button" id="SubBtn" class="btn btn-info" value="SUBMIT" style="color:black; font-size:1rem; width:100px;" />
						</div>
					</div>
				</div>
				<div class="BoxBgWa feedback-right" style="font-size: 2.3rem;">
