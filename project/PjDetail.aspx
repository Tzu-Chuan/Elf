                                      ...
                                      <div id="accordion_1" class="panel-group acc-v1">
                                          <div class="panel panel-default">
                                              <div class="panel-heading">
                                                  ...
                                                  <!--功能-連結-->
                                                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_1" href="#pageBlock_all">all articles</a>
                                              </div>

                                              <div id="pageBlock_all" class="panel-collapse collapse in" typeid="{$typeId}" typeguid="{$typeGuid}">
                                                  <!--排序-->
                                                  <div class="row">
