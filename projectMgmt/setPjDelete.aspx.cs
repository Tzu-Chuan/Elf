...
public partial class projectMgmt_setPjDelete : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            int count = dao.exec_project_delete(req.pjGuid);
        ...
        catch (Exception ex)
        {
            ...
            Response.Write("Error message, project delete exception!!");
        }
    }
