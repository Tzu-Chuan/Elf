...
public partial class projectMgmt_setPjStart : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            int count = dao.exec_project_start(req.pjGuid);
        ...
        catch (Exception ex)
        {
            ...
            Response.Write("Error message, project start exception!!");
        }
    }
